...
trait SoftDeletes {
    ...
    protected function performDeleteOnModel()
    {
        if ($this->forceDeleting) {
            ...
            $this->getConnection()->table($this->getVersionTable())
                ->where($this->getVersionKeyName(), $this->getKey())
                ->delete();
    ...
    /**
     * Determine if the model uses versionable softDeletes.
     *
     * @return bool
     */
    public function usesVersionableSoftDeletes()
    {
        $deletedAt = $this->getDeletedAtColumn();

        return in_array($deletedAt, $this->versioned);
    }

    /**
     * Determine if the model uses normal softDeletes.
     *
     * @return bool
     */
    ...
    public function getQualifiedDeletedAtColumn()
    {
        ...
        if ($this->usesVersionableSoftDeletes()) {
